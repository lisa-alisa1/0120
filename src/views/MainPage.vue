      ...
      <div class="message-block">
        <div class="header">
          ...
          <div class="profile-info">
            <p class="name"> Eva Jonson </p>
            <p class="prof"> Sales Manager </p>
            <div>
              <p>
